...
if (require.main === module) {
  ...
  if (args.length === 0) {
    ...
    console.log("  node interpreter.js --demo              - Run demo examples");
    console.log("\nExample:");
  ...
  if (args[0] === '--demo') {
    console.log("=== Sathi Language Demo ===\n");
    
    console.log("Example 1: Basic Variable");
    runSathi(`
sathi yo ho x = 10
sathi yo ho y = 20
sathi bhana(x + y)
...
sathi yo ho a = 5
sathi yo ho b = 3
sathi yo ho c = a * b + 10
sathi bhana(c)
`);

    console.log("\nExample 3: Calculator");
    runSathi(`
sathi yo ho price = 100
sathi yo ho tax = 18
sathi yo ho total = price + tax
sathi bhana(total)
`);
  } else {
